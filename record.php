...
?>
    <div class="container-record">
        ...
        <p>ชื่อผู้ป่วย</p>
        <div class="input-n">
            <input type="text" id="name-in" placeholder="Name" class="in-n" disabled>
            <input type="text" id="sur-in" placeholder="Surname" class="in-n" disabled>
        </div>
        ...
        <div class="disease-field">
            <div class="disease-in">
              ...
              <textarea name="text" id="disease" cols="65" rows="4" disabled></textarea>
            </div>
        </div>
